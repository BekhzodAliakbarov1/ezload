...
const LoadInfoSkeloton = () => {
  return (
    ...
    >
      <Box display="flex" flexDirection="column" gap="16px" marginBottom="30px">
      ...
      <Box
        ...
        marginBottom="30px"
      >
        <Box width="200px" display="flex" flexDirection="column" gap="8px">
          <Skeleton variant="text" width="82px" height="16px" />
          <Skeleton variant="text" width="200px" height="20px" />
        </Box>
        <Box width="87px" display="flex" flexDirection="column" gap="8px">
          <Skeleton variant="text" width="87px" height="16px" />
          <Skeleton variant="text" width="77px" height="20px" />
        </Box>
        <Box width="122px" display="flex" flexDirection="column" gap="8px">
          <Skeleton variant="text" width="61px" height="16px" />
          <Skeleton variant="text" width="122px" height="20px" />
        </Box>
      </Box>
      <Box display="flex" flexDirection="column" gap="8px" marginBottom="30px">
        <Skeleton variant="text" width="82px" height="16px" />
